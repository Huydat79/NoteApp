...
public class ShareNote extends Note {
    ...
    public ShareNote(String receiver, ShareType shareType, int id, String author, String header, String content, int lastModified, Date lastModifiedDate, List<NoteFilter> filters) {
        super(id, author, header, content, lastModified, lastModifiedDate, filters);
        this.receiver = receiver;
        this.shareType = shareType;
    }
